...
import { Check, Star, Users, Globe, Shield, Calendar, GraduationCap, Headphones } from "lucide-react";
  ...
  const membershipMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        ...
        description: "Our team will contact you within 24 hours to complete your membership.",
      });
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto mb-16 text-center">
          ...
          <p className="mt-4 text-gray-600">
            Already have your details ready? Use the form below to submit your membership application
          </p>
        </div>
        ...
        <div className="max-w-2xl mx-auto">
          <Card>
            <CardHeader className="text-center">
              <CardTitle className="text-2xl">Submit Membership Application</CardTitle>
              <CardDescription>
            ...
            <CardContent>
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  >
                    {membershipMutation.isPending ? "Processing..." : "Submit Application"}
                  </Button>
                  
                  <p className="text-sm text-gray-600 text-center mt-4">
                    Fill out this form to submit your membership application. Our team will contact you within 24 hours.
                  </p>
                </form>
              </Form>
            </CardContent>
